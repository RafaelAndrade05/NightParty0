...
public class LoginActivity extends AppCompatActivity {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (document != null && document.exists()) {
                                    Log.d("FACEBOOKAUTH", "YA EXISTE USUARIO " + document.getData());
                                    addTokenDispositivo(user.getUid());
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(!task.isSuccessful()){
                    ...
                    Log.e("tokenErrror", task.getException().getMessage());
                }
            }
        });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.button_cuenta_negocio:
                Intent l = new Intent(this, LoginBusinessActivity.class);
                startActivity(l);
                break;
